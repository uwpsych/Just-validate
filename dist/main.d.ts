...
declare class JustValidate {
    ...
    handleFieldEvent: (target: HTMLInputElement, afterInputChanged?: boolean) => void;
    handleGroupEvent: (target: HTMLInputElement, afterInputChanged?: boolean) => void;
    ...
    setListeners(elem: HTMLInputElement, type: string, handler: (ev: Event) => void): void;
