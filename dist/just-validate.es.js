...
class JustValidate {
  constructor(form, globalConfig, dictLocale) {
    ...
    __publicField(this, "handleFieldEvent", (target, afterInputChanged = true) => {
      let foundKey;
    ...
    __publicField(this, "handleGroupEvent", (target, afterInputChanged = true) => {
      let foundKey;
    ...
    __publicField(this, "handlerEvent", (ev) => {
      if (!ev.target) {
        return;
      }
      const afterInputChanged = ev.type !== "blur";
      this.handleFieldEvent(ev.target, afterInputChanged);
      this.handleGroupEvent(ev.target);
      this.renderErrors();
    });
  ...
  addField(fieldSelector, rules, config) {
    ...
    if (config == null ? void 0 : config.validateOnBlur) {
